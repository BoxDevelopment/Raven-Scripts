...
boolean checkStatus() {
    ...
    return sidebar != null && util.strip(sidebar.get(0)).startsWith("HALLOWEEN SIMULATOR") || util.strip(sidebar.get(0)).startsWith("GRINCH SIMULATOR") || util.strip(sidebar.get(0)).startsWith("EASTER SIMULATOR");
}
